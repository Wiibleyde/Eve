...
export const blague: ICommand = {
    ...
    execute: async (interaction) => {
        ...
        const button = new ButtonBuilder()
            .setCustomId('jokeSetPublicButton')
            .setLabel('Rendre publique')
...
export function jokeBasicEmbedGenerator() {
    ...
    embed.setAuthor({
        name: 'Eve - Blague',
        iconURL:
            'https://cdn.discordapp.com/attachments/1373968524229218365/1374021216360206388/latest.png?ex=682c887a&is=682b36fa&hm=141ddd2a49ccc4667737e5d19fd5158cfb76c574f98aaa6ff17e29860067f5e0&',
    });
    return embed;
}
