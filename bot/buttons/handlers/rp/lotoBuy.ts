...
export async function lotoBuy(interaction: ButtonInteraction): Promise<void> {
    ...
    const modal = new ModalBuilder().setCustomId(`lotoBuyModal--${gameUuid}`).setTitle('Ajouter des tickets');
