...
func (*GuildConfig) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case guildconfig.FieldGuildID, guildconfig.FieldKey, guildconfig.FieldValue:
			values[i] = new(sql.NullString)
		case guildconfig.FieldCreatedAt, guildconfig.FieldUpdatedAt:
...
// GetValue returns the ent.Value that was dynamically selected and assigned to the GuildConfig.
// This includes values selected through modifiers, order, etc.
func (_m *GuildConfig) GetValue(name string) (ent.Value, error) {
