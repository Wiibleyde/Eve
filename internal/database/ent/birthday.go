...
func (*Birthday) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case birthday.FieldBirthday, birthday.FieldCreatedAt, birthday.FieldUpdatedAt:
...
func (_m *Birthday) assignValues(columns []string, values []any) error {
...
func (_m *Birthday) Value(name string) (ent.Value, error) {
...
func (_m *Birthday) Update() *BirthdayUpdateOne {
	return NewBirthdayClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the Birthday entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *Birthday) Unwrap() *Birthday {
...
func (_m *Birthday) String() string {
