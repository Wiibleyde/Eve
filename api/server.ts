...
import { lotoStatsHandler, lotoWinnersHandler } from './handlers/loto';
...
api.get(`${BASE_API_PATH}/loto/stats`, lotoStatsHandler);
api.get(`${BASE_API_PATH}/loto/winners`, lotoWinnersHandler);
