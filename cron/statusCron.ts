...
const possibleStatus: { name: string; type: ActivityType }[] = [
	{ name: `Regarde les merveilles de ce monde.`, type: ActivityType.Watching },
	{ name: `Écoute vos instructions.`, type: ActivityType.Listening },
	{ name: `Regarde les données de mission.`, type: ActivityType.Watching },
	{ name: `Regarde les étoiles.`, type: ActivityType.Watching },
];
const possibleHalloweenStatus: { name: string; type: ActivityType }[] = [
	{
		name: `Participe à la préparation des citrouilles. 🎃`,
		type: ActivityType.Competing,
	},
	{ name: `Regarde les fantômes... 👻`, type: ActivityType.Watching },
	{ name: `Spooky Scary Skeletons`, type: ActivityType.Listening },
	{ name: `Joue à des bonbons ou un sort ! 🍬`, type: ActivityType.Playing },
];
const possibleChristmasStatus: { name: string; type: ActivityType }[] = [
	{
		name: `Participe à l'emballage des cadeaux. 🎁`,
		type: ActivityType.Competing,
	},
	{ name: `Regarde les lutins. 🧝`, type: ActivityType.Watching },
	{ name: `Chante des chants de Noël`, type: ActivityType.Listening },
	{ name: `Joue avec le Père Noël. 🎅`, type: ActivityType.Playing },
];
